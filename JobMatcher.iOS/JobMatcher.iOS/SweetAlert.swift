...
@objc class SweetAlert: UIViewController {
    ...
    private func setupContentView() {
        contentView.backgroundColor = UIColor.grayColor().colorWithAlphaComponent(0.8) //UIColor(white: 1.0, alpha: 0.8)
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: UIColor.colorFromRGB(0x7bb8c3))
        userAction = action
        return self
    }
